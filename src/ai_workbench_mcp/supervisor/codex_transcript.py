...
and generates AI Workbench evidence folders.
...
def extract_transcript(
    ...
    """Extract a Codex session into AI Workbench evidence format.
    ...
    ev_dir = Path(evidence_dir or os.path.join(project_dir, "runs", f"codex-transcript-{session_file.stem}"))
