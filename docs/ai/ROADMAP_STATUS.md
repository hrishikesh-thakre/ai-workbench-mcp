...
| PyPI and package plumbing | PyPI published | Package build checks, wheel smoke, TestPyPI install, and exact-version PyPI install passed for `0.2.0a0`; MCP Registry submission remains pending |
