...
class OperationContractTests(unittest.TestCase):
    ...
    def test_validate_run_direct_call_writes_artifact_and_wraps_payload(self) -> None:
        ...
        self.assertEqual(response["summary"]["commands_passed"], 19)
        ...
        self.assertIn("setup_codex_help", command_names)
        self.assertIn("reports_show_help", command_names)
        self.assertIn("model_registry_override_support", command_names)
        self.assertIn("event_ledger_import_smoke", command_names)
        self.assertIn("golden_eval_module_help", command_names)
        self.assertIn("policy_pack_select_module_help", command_names)
        self.assertNotIn("codex_live_handoff_help", command_names)
        self.assertNotIn("codex_live_result_check_help", command_names)
