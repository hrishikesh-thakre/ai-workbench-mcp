...
Read the outcome and `policy_pack` from `pr_decision.json`, then use
`pr_comment.md` as the PR-facing surface. The comment is generated from
Workbench evidence only and does not embed raw model output or provider logs.
